...
export const skillCategories = [
  ...
  {
    label: 'Architecture',
    skills: ['Design systems', 'reusable components', 'server rendering', 'performance'],
  },
  {
    label: 'Quality',
    skills: ['Vitest', 'Jest', 'Playwright', 'React Testing Library', 'Mock Service Worker'],
  },
  {
    label: 'Accessibility',
    skills: ['WCAG', 'ARIA', 'axe DevTools', 'eslint-plugin-jsx-a11y'],
  },
  {
    label: 'Platform & operations',
    skills: ['Node', 'CI/CD', 'Docker', 'Vercel', 'Splunk'],
  },
  {
    label: 'Applied AI',
    skills: ['OpenAI API', 'RAG', 'structured retrieval', 'AI evaluation'],
  },
];
