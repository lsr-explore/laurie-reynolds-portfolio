...
export const stories: Story[] = [
  {
    ...
    atAGlance: [
      ...
      },
      {
        ...
        value: 'Architecture and outcomes are described at a public, non-proprietary level',
      },
    ],
    context: [
  ...
  },
  {
    ...
    atAGlance: [
      ...
      {
        label: 'My role',
        value: 'Staff Front-End Software Engineer and front-end integration lead',
      },
      {
        label: 'Team',
        value:
      ...
      {
        label: 'Confidentiality',
        value: 'Program details and architecture are described at a public, non-proprietary level',
      },
    ],
    context: [
    ...
    workflow: {
      intro: 'The public-facing flow can be summarized without exposing proprietary services:',
  ...
  },
  {
    ...
    technologies: ['C++', 'Medical imaging', 'Real-time systems', 'FDA regulated'],
  },
];
