...
export const metadata: Metadata = {
  ...
  description:
    'Learn about Laurie Reynolds — a senior front-end engineer with 30+ years of experience building secure, accessible systems across healthcare, payments, and civic tech.',
};
