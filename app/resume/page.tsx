...
const resumeSkills = [
  [
    ...
    'TypeScript, JavaScript (ES6+), React, Next.js, Node.js, GraphQL, Python, Vue, Tailwind CSS, D3.js, Figma, Redux, Design Systems, SSR',
  ],
  ['AI & Data', 'OpenAI API, RAG, Postgres/pgvector, AI evaluation'],
  [
    'Testing & Tooling',
    'Vitest, Jest, Playwright, React Testing Library, Mock Service Worker, axe DevTools, eslint-plugin-jsx-a11y',
  ],
  ['DevOps & Deployment', 'Docker, CI/CD, Vercel, Splunk, PostgreSQL, MSSQL, MySQL'],
  [
    'Other',
    'Accessibility (a11y), Performance Optimization, PCI DSS, CCPA, FDA 21 CFR Part 11, Agile, Scrum Certification',
  ],
];
...
const experience = [
  ...
  },
  {
    ...
    tech: [
      ...
      'axe DevTools',
      'Chrome DevTools',
      'Custom A/B experimentation platform',
      'Accessibility',
    ],
  },
  {
...
const earlierExperience = [
  {
    ...
    period: '1+ year',
    description:
      'Managed laboratory software development in a biotech startup using C#, WPF, SQL Server, Python, Django, and D3.js.',
  },
  {
    ...
    <section className="page-container py-16 md:py-24">
      <div className="mb-12 flex flex-col items-center gap-4 text-center sm:flex-row sm:justify-between sm:text-left">
        <div>
          ...
          <p className="mt-2 text-muted-foreground">Senior Front-End Software Engineer</p>
      ...
      <h2 className="mb-6 text-2xl font-bold">Regulated &amp; Medical Software Engineering</h2>
      <p className="mb-6 text-sm text-muted-foreground">
        Senior engineering roles across medical imaging, biotech, and regulated scientific systems
        (1999 — 2013).
      </p>
      ...
      <Card>
        <CardContent>
          <p className="text-sm text-muted-foreground">
            Rovi Corporation, Knight Ridder Digital, Associated Press, Thomson Grass Valley (Dubner
            Computer Systems), Tudor Investments, Knight Ridder Financial, Sony Electronics (Medical
            Division).
          </p>
        </CardContent>
      </Card>
      ...
      <div className="space-y-4">
        <Card>
            ...
            <div className="flex flex-col gap-1 sm:flex-row sm:items-start sm:justify-between">
              <div>
                <CardTitle className="text-base">
                  Web Development &amp; A11y Evaluations (Volunteer)
                </CardTitle>
                <a
          ...
          <CardContent>
            <p className="text-sm text-muted-foreground">
              Accessibility evaluations for nonprofit and small-business websites; site updates plus
              type-checking and end-to-end testing added to CI.
            </p>
        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            ...
            <div className="flex flex-wrap gap-1.5">
              {['WordPress', 'Elegant Themes Divi', 'Event Calendar', 'Constant Contact'].map(
                (t) => (
                  <Badge key={t} variant="secondary" className="text-xs">
                    {t}
                  </Badge>
      ...
      <Card>
        <CardContent className="pt-6">
          <p className="font-medium">M.S. Mathematics, B.S. Computer Science</p>
          <p className="text-sm text-muted-foreground">
